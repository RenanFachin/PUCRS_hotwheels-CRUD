...
export const TypewriterEffect = ({
  ...
  return (
    <div
      className={cn(
        'font-bold leading-tight tracking-tighter lg:text-4xl',
        className,
      )}
    >
      {renderWords()}
      <motion.span
        ...
        className={cn(
          'hidden h-6 w-[4px] rounded-sm bg-highlight-500 md:inline-block md:h-6 lg:h-10',
          cursorClassName,
        )}
      ></motion.span>
    </div>
  ...
  return (
    <div className={cn('my-6 flex space-x-1', className)}>
      ...
      <motion.span
        ...
        className={cn(
          'block h-4 w-[4px]  rounded-sm bg-highlight-500 sm:h-6 xl:h-12',
          cursorClassName,
        )}
      ></motion.span>
    </div>
